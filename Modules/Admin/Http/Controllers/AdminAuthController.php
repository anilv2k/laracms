...
use Modules\Admin\Entities\AdminAuth;
...
class AdminAuthController extends Controller
{
    ...
    public function index(){
        ...
        return $this->theme->layout('login')->of('admin::admin.login')->render();
    }
    ...
    public function postLogin(){
        ...
        if(Auth::guard('admin')->attempt($cred)){
			...
			$response=array('message'=>'Invalid email/password.','status'=>false);
            echo json_encode($response);
    ...
    public function create()
    {
		...
		$developer->email = 'swapnil@gmail.com';
