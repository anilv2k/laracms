...
Route::prefix('/app/settings')->group(function() {
    ...
    Route::get('/admin_nav', 'SettingsController@index_admin_nav');
    Route::post('/admin_nav', 'SettingsController@store_admin_nav');
    Route::post('/admin_nav/update_order', 'SettingsController@update_admin_nav_order');
    Route::post('/admin_nav/{nav}', 'SettingsController@update_admin_nav');
